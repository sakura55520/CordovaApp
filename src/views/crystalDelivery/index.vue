        ...
        >
          <template slot="header">
            <el-tooltip class="item" effect="dark" placement="bottom">
              <template slot="content">
                <div>
                  掺杂剂扣料首轮次：（首轮次良品数+首轮次吊肩量） /
                  首轮次多晶硅投料 * (首轮次掺杂剂投料+首轮补掺)
                </div>
                <div>
                  掺杂剂扣料中间轮次：（当前轮次良品数 + 本轮次吊肩量）/
                  （至该轮次多晶硅总投料量 - 前置轮次总良品数 -
                  前置轮次总吊肩量）* （前置轮次掺杂剂总投料 + 前置轮次总补掺 -
                  前置轮次掺杂剂总扣料 + 本轮次掺杂剂投料 +本轮次补掺）
                </div>
                <div>
                  掺杂剂扣料尾轮次：轮次总掺杂投料 + 轮次总补掺 - 前置轮次总扣料
                </div>
              </template>
